...
input_gff_files = ["12X_annotation_NCBI/NCBI_original_tidy_loc.gff3"]

original_genome_files = ["12X_genome_NCBI/12X_genome_NCBI.fasta"]

input_gff_tags = ["NCBI_original"]
