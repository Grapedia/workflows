...
gff files for PN40024 v5 which has genome divided in ref and alt
...
input_gff_files = ["12Xv2_annotation/out_gffs/catalogue_v3_on_12Xv2_output.gff3"]

original_genome_files = ["12Xv2_genome/12Xv2_genome.fasta"]

input_gff_tags = ["v3_catalogue"]

target_tags = ["ref", "alt"]
target_genome_fasta_files = ["T2T_genome/T2T_ref.fasta",
                             "T2T_genome/T2T_alt.fasta"]
