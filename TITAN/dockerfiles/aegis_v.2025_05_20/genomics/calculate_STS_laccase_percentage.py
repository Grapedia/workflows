...
location = f"{pickle_path}_STS_LAC_catalogue_v3_on_40X_ref_annotation.pkl"
if os.path.isfile(location):
    a1 = pickle_load(location)
else:
    root = a.path.split("40X_annotation_transfer")[0]
    a1 = a.copy()
    a1.add_gene_names_and_descriptors(file_path=f"../../genomes_and_annotation/grapevine/PN40024/12Xv2_annotation/catalogue/vvi_lab_catalogue_V4_TM39_unofficial_alternative_stats_STS_LAC.csv")
...
location = f"{pickle_path}_STS_LAC_catalogue_v3_pseudo_on_40X_ref_annotation.pkl"
if os.path.isfile(location):
    a_pseudo = pickle_load(location)
else:
    root = a.path.split("40X_annotation_transfer")[0]
    a_pseudo = a.copy()
    a_pseudo.add_gene_names_and_descriptors(file_path=f"../../genomes_and_annotation/grapevine/PN40024/12Xv2_annotation/catalogue/vvi_lab_catalogue_V4_TM39_unofficial_alternative_pseudo_STS_LAC.csv")
...
location = f"{pickle_path}_STS_LAC_catalogue_v3_expressed_on_40X_ref_annotation.pkl"
if os.path.isfile(location):
    a_expressed = pickle_load(location)
else:
    root = a.path.split("40X_annotation_transfer")[0]
    a_expressed = a.copy()
    a_expressed.add_gene_names_and_descriptors(file_path=f"../../genomes_and_annotation/grapevine/PN40024/12Xv2_annotation/catalogue/vvi_lab_catalogue_V4_TM39_unofficial_alternative_expressed_STS_LAC.csv")
...
pie_chart(list(d.keys()), list(d.values()), f"{b.path}/out_stats/", f"{a1.id}_{b.id}_found_catalogue_genes_STS_LAC", f"STS_LAC overlap scores of {a1.id} with {b.id} annotation", hovertext_labels=list(d_labels.values()), colours="extreme")
...
pie_chart(list(d.keys()), list(d.values()), f"{b.path}/out_stats/", f"{a_pseudo.id}_{b.id}_found_catalogue_genes_STS_LAC", f"STS_LAC overlap scores of {a_pseudo.id} with {b.id} annotation", hovertext_labels=list(d_labels.values()), colours="extreme")
...
pie_chart(list(d.keys()), list(d.values()), f"{b.path}/out_stats/", f"{a_expressed.id}_{b.id}_found_catalogue_genes_STS_LAC", f"STS_LAC overlap scores of {a_expressed.id} with {b.id} annotation", hovertext_labels=list(d_labels.values()), colours="extreme")
