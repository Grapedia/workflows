...
pie_chart(list(d.keys()), list(d.values()), f"{b.path}/out_stats/", f"{a1.id}_{b.id}_found_catalogue_genes_simplified", f"Simplified overlap scores of {a1.id} with {b.id} annotation", hovertext_labels=list(d_labels.values()), colours="extreme")
...
pie_chart(list(d.keys()), list(d.values()), f"{b.path}/out_stats/", f"{a_pseudo.id}_{b.id}_found_catalogue_genes_simplified", f"Simplified overlap scores of {a_pseudo.id} with {b.id} annotation", hovertext_labels=list(d_labels.values()), colours="extreme")
...
pie_chart(list(d.keys()), list(d.values()), f"{b.path}/out_stats/", f"{a_expressed.id}_{b.id}_found_catalogue_genes_simplified", f"Simplified overlap scores of {a_expressed.id} with {b.id} annotation", hovertext_labels=list(d_labels.values()), colours="extreme")
