...
a.add_gene_names_and_descriptors("/media/tomslab3/hard_drive/Documents/10.postdoc_i2sysbio/genomes_and_annotation/algae/chlamydomonas_reinhardtii/6.1_annotation/names/names.csv", sep=",", just_gene_names=True)
