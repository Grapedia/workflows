...
// Include workflows
include { generate_evidence_data } from "./workflows/generate_evidence_data.nf"
include { aegis } from "./workflows/aegis.nf"
...
workflow {
    ...
    if (params.workflow == "generate_evidence_data" || params.workflow == "all") {
        workflow_generate_evidence_data_outputs = generate_evidence_data(samples_list_long_reads, samples_list_short_reads, protein_list) // Give channels as parameters
        workflow_generate_evidence_data_outputs = workflow_generate_evidence_data_outputs.flatten()
    }
