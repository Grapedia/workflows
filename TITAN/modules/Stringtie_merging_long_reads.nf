...
process Stringtie_merging_long_reads {
  ...
  containerOptions "--volume ${params.output_dir}:/outputdir --volume ${projectDir}/scripts/:/scripts --volume ${projectDir}/work:/work --volume ${params.output_dir}/intermediate_files/evidence_data/transcriptomes/StringTie/long_reads/:/StringTie_long_reads"
  cpus 4
