...
workflow {
  ...
  // need to be run on masked genome generated by RepeatMasker
  // run_maker(EDTA.out.masked_genome,conversion_gtf_gff3.out.stranded_gff3.parent,conversion_gtf_gff3.out.stranded_gff3.name,file(params.protein_samplesheet).getParent(),file(params.protein_samplesheet).getName())
  ...
  // run_geneid(EDTA.out.masked_genome,file(params.geneid_param_file).getParent(),file(params.geneid_param_file).getName()) // VALIDATED
