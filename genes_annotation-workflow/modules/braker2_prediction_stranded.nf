...
process braker2_prediction_stranded {
  ...
  containerOptions "--volume ${projectDir}/scripts:/scripts --volume ${genome_path}:/genome_path --volume $params.outdir/evidence_data/RNAseq_stranded/alignments/new_assembly:/alignments"
  ...
  script:
    ...
    --prot_seq=\${proteins} \
    --cores=${task.cpus} --workingdir={params.outdir} --etpmode --softmasking --gff3 \
