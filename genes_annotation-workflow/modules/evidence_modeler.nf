...
process evidence_modeler {
  ...
  script:
    ...
    /scripts/evidencemodeler.sh -e \$PWD \
        ...
        -g $glimmerhmm_predictions_out -l $liftoff_previous_annotations_out -m $maker_predictions_out -b "$braker2_prediction_stranded braker2_prediction_unstranded" -r $EDTA_TE_annot \
